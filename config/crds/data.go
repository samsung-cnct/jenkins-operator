...
func jenkins_v1alpha1_jenkinsinstanceYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "jenkins_v1alpha1_jenkinsinstance.yaml", size: 3010, mode: os.FileMode(420), modTime: time.Unix(1536275824, 0)}
...
func jenkins_v1alpha1_jenkinsjobYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "jenkins_v1alpha1_jenkinsjob.yaml", size: 1526, mode: os.FileMode(420), modTime: time.Unix(1536275824, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
