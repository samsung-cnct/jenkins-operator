...
import (
	...
	. "github.com/maratoid/jenkins-operator/pkg/apis/jenkins/v1alpha1"
	. "github.com/maratoid/jenkins-operator/pkg/client/clientset/versioned/typed/jenkins/v1alpha1"
)

// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the JenkinsPlugin resource tests

var _ = Describe("JenkinsPlugin", func() {
	var instance JenkinsPlugin
	var expected JenkinsPlugin
	var client JenkinsPluginInterface

	BeforeEach(func() {
		instance = JenkinsPlugin{}
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.JenkinsV1alpha1().JenkinsPlugins("default")
