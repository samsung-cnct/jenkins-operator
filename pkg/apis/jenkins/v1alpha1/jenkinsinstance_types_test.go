...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the JenkinsInstance resource tests

var _ = Describe("JenkinsInstance", func() {
	var instance JenkinsInstance
	var expected JenkinsInstance
	var client JenkinsInstanceInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.JenkinsV1alpha1().JenkinsInstances("default")
