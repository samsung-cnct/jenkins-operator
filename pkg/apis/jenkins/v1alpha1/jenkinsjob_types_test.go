...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the JenkinsJob resource tests

var _ = Describe("JenkinsJob", func() {
	var instance JenkinsJob
	var expected JenkinsJob
	var client JenkinsJobInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.JenkinsV1alpha1().JenkinsJobs("default")
