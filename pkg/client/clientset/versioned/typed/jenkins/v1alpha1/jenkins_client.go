...
type JenkinsV1alpha1Client struct {
	restClient rest.Interface
}
...
func NewForConfig(c *rest.Config) (*JenkinsV1alpha1Client, error) {
	config := *c
	...
	return &JenkinsV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new JenkinsV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *JenkinsV1alpha1Client {
...
// New creates a new JenkinsV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *JenkinsV1alpha1Client {
	return &JenkinsV1alpha1Client{c}
}
...
func (c *JenkinsV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
