...
import (
	...
	jenkins "github.com/maratoid/jenkins-operator/pkg/client/informers/externalversions/jenkins"
...
type SharedInformerFactory interface {
	...
	Jenkins() jenkins.Interface
}

func (f *sharedInformerFactory) Jenkins() jenkins.Interface {
	return jenkins.New(f, f.namespace, f.tweakListOptions)
}
