...
import (
	...
	scheme "github.com/maratoid/jenkins-operator/pkg/generated/jenkinsoperator/client/clientset/versioned/scheme"
...
type JenkinsServerInterface interface {
	...
	UpdateStatus(*v1alpha1.JenkinsServer) (*v1alpha1.JenkinsServer, error)
...
func (c *jenkinsServers) UpdateStatus(jenkinsServer *v1alpha1.JenkinsServer) (result *v1alpha1.JenkinsServer, err error) {
	result = &v1alpha1.JenkinsServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("jenkinsservers").
