...
func (c *FakeJenkinsServers) List(opts v1.ListOptions) (result *v1alpha1.JenkinsServerList, err error) {
	...
	list := &v1alpha1.JenkinsServerList{ListMeta: obj.(*v1alpha1.JenkinsServerList).ListMeta}
...
func (c *FakeJenkinsServers) UpdateStatus(jenkinsServer *v1alpha1.JenkinsServer) (*v1alpha1.JenkinsServer, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(jenkinsserversResource, "status", c.ns, jenkinsServer), &v1alpha1.JenkinsServer{})
