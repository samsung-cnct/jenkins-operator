...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "JenkinsInstance Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("JenkinsInstanceController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("JenkinsInstanceController")
})
