...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileJenkinsPlugin{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Uncomment watch a Deployment created by JenkinsPlugin - change this for objects you create
...
func (r *ReconcileJenkinsPlugin) Reconcile(request reconcile.Request) (reconcile.Result, error) {
