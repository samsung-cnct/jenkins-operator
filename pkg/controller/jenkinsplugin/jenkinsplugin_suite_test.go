...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "JenkinsPlugin Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("JenkinsPluginController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("JenkinsPluginController")
})
