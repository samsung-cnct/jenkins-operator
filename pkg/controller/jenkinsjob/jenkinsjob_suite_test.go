...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "JenkinsJob Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("JenkinsJobController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("JenkinsJobController")
})
